...
<?php 
$leftAds = \App\library\SiteHelper::getLeftAds('otherpages',0)->toArray();
$rightAds = \App\library\SiteHelper::getRightAds('otherpages',0)->toArray();
$botAdsot = \App\library\SiteHelper::getBottomAds('otherpages',0)->toArray();
$allAds = array_merge($rightAds,$leftAds, $botAdsot);
    ...
    <div class="col-md-12 cls-bottom-add-item ">
        <a href="{{ ($allAds[$addCnt]['image_link']) ? $allAds[$addCnt]['image_link'] : '#' }}"
            ...
            <img class="" height="200" width="100%"
                src="{{$allAds[$addCnt]['image']? url("uploads/adsimages/".$allAds[$addCnt]['image']) : url("/images/image_not_found.jpg")}}"
                alt="Card image cap">
            <br>
