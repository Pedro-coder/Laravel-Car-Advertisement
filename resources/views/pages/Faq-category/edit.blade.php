                            ...
                            <div class="col-md-6">
                                ...
                                <div class="tab-content">
                                    <div id="home" class="container tab-pane active"><br>
                                        <form action="{{ route('faq.category.update', $faq->id) }}" method="post" enctype="multipart/form-data">
                                            @csrf
                                            {{ method_field('PUT') }}
                                            <div class="form-group">
                                                <label>Parent Category</label>
                                                <input type="text" name="parent" class="form-control" value="{{ $faq->parent->name }}">
                                            </div>
                                            <div class="form-group">
                                                <label>Icon</label>
                                                <input type="file" name="parent_icon" class="form-control">
                                                <img src="{{ Storage::url('/faq-category/'.$faq->parent->icon) }}" style="height: 100px;width: 100px;">
                                            </div>
                                            <div class="form-group">
                                                <label>Category Name</label>
                                                <input type="text" name="category" class="form-control" value="{{ $faq->name }}">
                                            </div>
                                            <div class="form-group">
                                                <label>Icon</label>
                                                <input type="file" name="category_icon" class="form-control">
                                                <img src="{{ Storage::url('/faq-category/'.$faq->icon) }}" style="height: 100px;width: 100px;">
                                            </div>
